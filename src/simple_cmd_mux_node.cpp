...
//  nodelet.load(nodelet_name, "romea_command_mux/FourWheelSteeringSimpleCmdMuxNodelet", remap, my_argv);
#endif

#ifdef ACKERMANN_STEERING
  std::cout << "ACKERMANN_STEERING "<< std::endl;
//  nodelet.load(nodelet_name, "romea_command_mux/AckermannSimpleCmdMuxNodelet", remap, my_argv);
#endif
