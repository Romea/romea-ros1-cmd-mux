...
//CmdMuxDiagnostics::CmdMuxDiagnostics()
//{
//  diagnostic_.add("Twist mux status", this, &CmdMuxDiagnostics::diagnostics);
...
//void CmdMuxDiagnostics::update()
//{
//  diagnostic_.update();
//}

//void CmdMuxDiagnostics::updateStatus(const status_type::ConstPtr& status)
//{
...
//void CmdMuxDiagnostics::diagnostics(diagnostic_updater::DiagnosticStatusWrapper& stat)
//{
